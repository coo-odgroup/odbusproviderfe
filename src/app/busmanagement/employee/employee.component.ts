...
export class EmployeeComponent implements OnInit {  
 ...
 // busoperators: any;
  ...
  constructor( private spinner: NgxSpinnerService,
    private employeeService: EmployeeService,private http: HttpClient,private notificationService: NotificationService,private fb: FormBuilder,private modalService: NgbModal,config: NgbModalConfig) {
    this.isSubmit = false;
  ...
  ResetAttributes()
  {
        ...
        this.ModalHeading = "Add Employee";
        this.ModalBtn = "Save";
  }
