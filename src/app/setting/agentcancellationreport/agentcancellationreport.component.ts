...
@Component({
  selector: 'app-agentcancellationreport',
  templateUrl: './agentcancellationreport.component.html',
  styleUrls: ['./agentcancellationreport.component.scss']
})
export class AgentcancellationreportComponent implements OnInit {
  ...
  search(pageurl="")
  {
    ...
    {
      this.rs.cancelReport(data).subscribe(
        res => {
          this.completedata= res.data;
          // console.log( this.completedata);
          this.spinner.hide();
