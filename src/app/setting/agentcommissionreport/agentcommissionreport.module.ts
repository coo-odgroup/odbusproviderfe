...
import {AgentcommissionreportRoutingModule} from './agentcommissionreport-routing.module';
...
@NgModule({
  imports: [
    CommonModule,
    AgentcommissionreportRoutingModule,
    SharedModule,
    FormsModule,
    NgSelectModule,
...
export class AgentcommissionreportModule { }