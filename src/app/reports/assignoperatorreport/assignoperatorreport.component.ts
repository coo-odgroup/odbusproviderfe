...
@Component({
  selector: 'app-assignoperatorreport',
  templateUrl: './assignoperatorreport.component.html',
  styleUrls: ['./assignoperatorreport.component.scss']
})
export class AssignoperatorreportComponent implements OnInit {
  ...
  search(pageurl="")
  {
    ...
    {
      this.rs.assocAssignOperatorReport(data).subscribe(
        res => {
