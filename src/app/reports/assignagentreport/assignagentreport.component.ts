...
@Component({
  selector: 'app-assignagentreport',
  templateUrl: './assignagentreport.component.html',
  styleUrls: ['./assignagentreport.component.scss']
})
export class AssignagentreportComponent implements OnInit {
  ...
  search(pageurl="")
  {
    ...
    if(pageurl!="")
    {
      this.rs.assocAssignAgentpaginationReport(pageurl,data).subscribe(
        res => {
    ...
    {
      this.rs.assocAssignAgentReport(data).subscribe(
        res => {
