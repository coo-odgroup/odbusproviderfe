...
export class VendorSeatblockService {
  ...
  getAllData(post): Observable<any> {
    return this.httpClient.post<any>(this.apiURL+ '/vendor-seatblockData', JSON.stringify(post), this.httpOptions)
    .pipe(
      catchError(this.errorHandler)
    )
  }
  ...
  create(data): Observable<any> {
    return this.httpClient.post<any>(this.apiURL + '/vendor-seatblock', JSON.stringify(data), this.httpOptions)
    .pipe(
      catchError(this.errorHandler)
    )
  }
  ...
  delete(post){
    return this.httpClient.post<any>(this.apiURL + '/delete-vendor-Seatblock',JSON.stringify(post), this.httpOptions)
    .pipe(
      catchError(this.errorHandler)
    )
  }
