...
export class AllapiclientComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.form = this.fb.group({
        ...
        alternate_email: [null, Validators.compose([Validators.required])],
  ...
  addAgent(){  
    ...
    const data = {
        ...
        alternate_email:this.form.value.alternate_email,
  ...
  editAgent(event : Event, id : any)
  {
    ...
    this.form = this.fb.group({
          ...
          alternate_email: [this.apiuserRecord.alternate_email,Validators.compose([Validators.required])],
