...
import { ApiClientWalletRequestRoutingModule} from './apiclientwalletrequest-routing.module';
...
@NgModule({
  imports: [
    CommonModule,
    ApiClientWalletRequestRoutingModule,
    SharedModule,
    FormsModule,
    NgSelectModule,
    NgxPrintModule,
...
export class ApiClientWalletRequestModule { }
