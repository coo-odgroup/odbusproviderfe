...
import { ApitransactionreportRoutingModule} from './apitransactionreport-routing.module';
...
@NgModule({
  imports: [
    CommonModule,
    ApitransactionreportRoutingModule,
    SharedModule,
    FormsModule,
    NgSelectModule,
    NgxPrintModule,
...
export class ApitransactionreportModule { }
