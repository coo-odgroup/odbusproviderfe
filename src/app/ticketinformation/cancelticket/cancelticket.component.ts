...
export class CancelticketComponent implements OnInit {
  ...
  search(pageurl = '') {
    ...
    if (pageurl != '') {
      this.acts.getAllaginationData(pageurl, data).subscribe((res) => {
      ...
      this.acts.getAllData(data).subscribe((res) => {
        this.cancelTickets = res.data.data.data;
        this.pagination = res.data.data;
        this.all = res.data;
        // console.log( this.cancelTickets);
  ...
  search_pnr() {
    ...
    this.cancelTicketForm.controls.is_customer_req.setValue('');
  ...
  cancelTicket() {
    ...
    const data = {
      ...
      is_customer_req: this.cancelTicketForm.value.is_customer_req,
